...
const About: React.FC = () => {
  ...
  const skills = [
    ...
    },
    {
      ...
      items: ["After Effects", "DaVinci Resolve", "Cinema 4D", "Spline", "Premiere Pro"]
    },
    {
      category: "Development",
      items: ["HTML5 & CSS3", "JavaScript", "Webflow", "GitHub", "WordPress"]
    },
    {
            ...
            <div id="skills" className="pt-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {skills.map((group, i) => (
                  ...
                  >
                    <h4 className="text-accent font-mono text-[10px] uppercase mb-3 tracking-widest">
                      {group.category}
                    </h4>
